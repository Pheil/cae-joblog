...
function clearAll() {
    ...
    self.port.emit("CAEJobLog-at-tenneco-dot-com:deleteNotes", "suzhou");
    location.reload();
}

function clearSizes() {
    var sizearray = new Array("suzhou", "");    //Sends empty string
    self.port.emit("CAEJobLog-at-tenneco-dot-com:SaveSizes", sizearray);
    location.reload();
}
...
self.port.emit("CAEJobLog-at-tenneco-dot-com:rtn_logged", "suzhou");
